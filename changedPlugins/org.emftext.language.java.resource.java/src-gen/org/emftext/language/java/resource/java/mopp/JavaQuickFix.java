...
public abstract class JavaQuickFix implements org.emftext.language.java.resource.java.IJavaQuickFix {
	...
	public JavaQuickFix(String displayString, String imageKey, EObject contextObject) {
		this(displayString, imageKey, Collections.singleton(contextObject), contextObject.eResource());
	}
	
	public JavaQuickFix(String displayString, String imageKey, Collection<EObject> contextObjects) {
		this(displayString, imageKey, contextObjects, contextObjects.iterator().next().eResource());
	}
	
	public JavaQuickFix(String displayString, String imageKey, Collection<EObject> contextObjects, Resource resource) {
		super();
	...
	public String apply(String currentText) {
		...
		try {
			...
			new org.emftext.language.java.resource.java.util.JavaRuntimeUtil().logError("Exception while applying quick fix", e);
		}
		return null;
	}
