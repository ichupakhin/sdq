 ...
 * to 4 bytes).
 */
public class JavaUnicodeConverter extends org.emftext.language.java.resource.java.mopp.JavaInputStreamProcessor {
	 ...
	 */
	public JavaUnicodeConverter(InputStream inputStream) {
