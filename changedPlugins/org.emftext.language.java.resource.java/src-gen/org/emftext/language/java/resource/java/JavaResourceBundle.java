...
public class JavaResourceBundle {
	 ...
	 * are running.
	 */
	public static String BUILDER_ADAPTER_TASK_NAME = "Building java file";
	...
	static {
		try {
			ResourceBundle bundle = ResourceBundle.getBundle(JavaResourceBundle.class.getName(), Locale.getDefault());
			if (bundle != null) {
				Set<String> keys = bundle.keySet();
				for (String key : keys) {
					String value = bundle.getString(key);
					try {
						Field field = JavaResourceBundle.class.getDeclaredField(key.toUpperCase());
