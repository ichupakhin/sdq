...
import org.emftext.language.java.resource.java.mopp.JavaResource.ElementBasedTextDiagnostic;

public class JavaCopiedEList<E> implements EList<E> {
	
	private EList<E> original;
	private EList<E> copy;
	
	@SuppressWarnings("unchecked")
	public JavaCopiedEList(EList<E> original) {
		super();
...
//	private void debug(E e)
//	{
//		if (e != null && e instanceof ElementBasedTextDiagnostic)
//			System.err.println("######################## ID: " + System.identityHashCode(e));
//	}
