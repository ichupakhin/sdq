...
public abstract class JavaANTLRParserBase extends Parser implements org.emftext.language.java.resource.java.IJavaTextParser {
	 ...
	 * result object.
	 */
	protected Collection<org.emftext.language.java.resource.java.IJavaCommand<org.emftext.language.java.resource.java.IJavaTextResource>> postParseCommands;
	 ...
	 */
	private org.emftext.language.java.resource.java.mopp.JavaTokenResolveResult tokenResolveResult = new org.emftext.language.java.resource.java.mopp.JavaTokenResolveResult();
	...
	public JavaANTLRParserBase(TokenStream input) {
		super(input);
	}
	
	public JavaANTLRParserBase(TokenStream input, RecognizerSharedState state) {
		super(input, state);
	}
	
	protected void retrieveLayoutInformation(EObject element, org.emftext.language.java.resource.java.grammar.JavaSyntaxElement syntaxElement, Object object, boolean ignoreTokensAfterLastVisibleToken) {
		...
		isElementToStore |= syntaxElement instanceof org.emftext.language.java.resource.java.grammar.JavaPlaceholder;
		isElementToStore |= syntaxElement instanceof org.emftext.language.java.resource.java.grammar.JavaKeyword;
		isElementToStore |= syntaxElement instanceof org.emftext.language.java.resource.java.grammar.JavaEnumerationTerminal;
		isElementToStore |= syntaxElement instanceof org.emftext.language.java.resource.java.grammar.JavaBooleanTerminal;
		if (!isElementToStore) {
			return;
		}
		...
		layoutInformationAdapter.addLayoutInformation(new org.emftext.language.java.resource.java.mopp.JavaLayoutInformation(syntaxElement, object, offset, hiddenTokenText.toString(), visibleTokenText.toString()));
	...
	protected <ContainerType extends EObject, ReferenceType extends EObject> void registerContextDependentProxy(final org.emftext.language.java.resource.java.mopp.JavaContextDependentURIFragmentFactory<ContainerType, ReferenceType> factory, final ContainerType container, final EReference reference, final String id, final EObject proxy) {
		final int position;
		if (reference.isMany()) {
	...
	protected void addMapEntry(EObject element, EStructuralFeature structuralFeature, org.emftext.language.java.resource.java.mopp.JavaDummyEObject dummy) {
		Object value = element.eGet(structuralFeature);
		Object mapKey = dummy.getValueByName("key");
		Object mapValue = dummy.getValueByName("value");
		if (value instanceof EMap<?, ?>) {
			EMap<Object, Object> valueMap = org.emftext.language.java.resource.java.util.JavaMapUtil.castToEMap(value);
	...
	protected EObject apply(EObject target, List<EObject> dummyEObjects) {
		...
		for (EObject object : dummyEObjects) {
			assert(object instanceof org.emftext.language.java.resource.java.mopp.JavaDummyEObject);
			org.emftext.language.java.resource.java.mopp.JavaDummyEObject dummy = (org.emftext.language.java.resource.java.mopp.JavaDummyEObject) object;
	...
	protected org.emftext.language.java.resource.java.mopp.JavaTokenResolveResult getFreshTokenResolveResult() {
		tokenResolveResult.clear();
		return tokenResolveResult;
	}
	
	protected org.emftext.language.java.resource.java.mopp.JavaReferenceResolverSwitch getReferenceResolverSwitch() {
		org.emftext.language.java.resource.java.mopp.JavaReferenceResolverSwitch resolverSwitch = (org.emftext.language.java.resource.java.mopp.JavaReferenceResolverSwitch) metaInformation.getReferenceResolverSwitch();
	...
	public boolean isLayoutInformationRecordingEnabled() {
		...
		Object value = options.get(org.emftext.language.java.resource.java.IJavaOptions.DISABLE_LAYOUT_INFORMATION_RECORDING);
	...
	public boolean isLocationMapEnabled() {
		...
		Object value = options.get(org.emftext.language.java.resource.java.IJavaOptions.DISABLE_LOCATION_MAP);
		return value == null || Boolean.FALSE.equals(value);
	}
