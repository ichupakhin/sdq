...
public class JavaMetaInformation implements org.emftext.language.java.resource.java.IJavaMetaInformation {
	...
	public org.emftext.language.java.resource.java.IJavaTextParser createParser(InputStream inputStream, String encoding) {
		return new org.emftext.language.java.resource.java.mopp.JavaParser().createInstance(inputStream, encoding);
	}
	
	public org.emftext.language.java.resource.java.IJavaTextPrinter createPrinter(OutputStream outputStream, org.emftext.language.java.resource.java.IJavaTextResource resource) {
	...
	public String getPathToCSDefinition() {
		return "org.emftext.language.java//org.emftext.language.java/metamodel/java.cs";
	}
	...
	public void registerResourceFactory() {
		...
		if (Factory.Registry.INSTANCE.getExtensionToFactoryMap().get(getSyntaxName()) == null) {
			Factory.Registry.INSTANCE.getExtensionToFactoryMap().put(getSyntaxName(), new org.emftext.language.java.resource.java.mopp.JavaResourceFactoryDelegator());
		}
	}
