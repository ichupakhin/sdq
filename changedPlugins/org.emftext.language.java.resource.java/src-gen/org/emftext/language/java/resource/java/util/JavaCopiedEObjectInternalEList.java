...
public class JavaCopiedEObjectInternalEList extends org.emftext.language.java.resource.java.util.JavaCopiedEList<EObject> implements InternalEList<EObject> {
	
	private InternalEList<EObject> original;
	private InternalEList<EObject> copy;
	
	public JavaCopiedEObjectInternalEList(InternalEList<EObject> original) {
		super(original);
