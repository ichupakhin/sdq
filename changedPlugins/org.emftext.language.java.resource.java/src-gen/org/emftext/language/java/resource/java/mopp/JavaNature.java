...
public class JavaNature implements IProjectNature {
	...
	public static final String NATURE_ID = "org.emftext.language.java.resource.java.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {org.emftext.language.java.resource.java.mopp.JavaBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(org.emftext.language.java.resource.java.mopp.JavaBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
