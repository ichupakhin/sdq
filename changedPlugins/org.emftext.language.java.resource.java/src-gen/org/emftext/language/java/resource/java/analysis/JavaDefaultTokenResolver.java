 ...
 * </p>
 */
public class JavaDefaultTokenResolver implements org.emftext.language.java.resource.java.IJavaTokenResolver {
	 ...
	 */
	public JavaDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public JavaDefaultTokenResolver(boolean escapeKeywords) {
		super();
		this.escapeKeywords = escapeKeywords;
	}
	
	public void resolve(String lexem, EStructuralFeature feature, org.emftext.language.java.resource.java.IJavaTokenResolveResult result) {
		resolve(lexem, feature, result, null, null, null);
	}
	
	public void resolve(String lexem, EStructuralFeature feature, org.emftext.language.java.resource.java.IJavaTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : org.emftext.language.java.resource.java.grammar.JavaGrammarInformationProvider.INSTANCE.getKeywords()) {
