 ...
 */
public class JavaFollowSetGroup {
	
	private List<org.emftext.language.java.resource.java.mopp.JavaExpectedTerminal> expectedTerminals = new ArrayList<org.emftext.language.java.resource.java.mopp.JavaExpectedTerminal>();
	
	public void add(org.emftext.language.java.resource.java.mopp.JavaExpectedTerminal expectedTerminal) {
		expectedTerminals.add(expectedTerminal);
	}
	
	public List<org.emftext.language.java.resource.java.mopp.JavaExpectedTerminal> getExpectedTerminals() {
	...
	public String toString() {
		return "JavaFollowSetGroup" + expectedTerminals;
	}
