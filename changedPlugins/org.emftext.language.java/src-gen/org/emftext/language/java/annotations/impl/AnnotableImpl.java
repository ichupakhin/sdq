 ...
 * <ul>
 *   <li>{@link org.emftext.language.java.annotations.impl.AnnotableImpl#getAnnotations <em>Annotations</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class AnnotableImpl extends CommentableImpl implements Annotable
{
  ...
  public EList<AnnotationInstance> getAnnotations()
  {
    if (annotations == null)
    {
      annotations = new EObjectContainmentEList.Resolving<AnnotationInstance>(AnnotationInstance.class, this, AnnotationsPackage.ANNOTABLE__ANNOTATIONS);
    }
    return annotations;
  }
