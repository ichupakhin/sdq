 ...
 * <ul>
 *   <li>{@link org.emftext.language.java.types.impl.TypedElementImpl#getTypeReference <em>Type Reference</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
  ...
  public TypeReference getTypeReference()
  {
    if (typeReference != null && typeReference.eIsProxy())
    {
      ...
      if (typeReference != oldTypeReference)
      {
        ...
        NotificationChain msgs = oldTypeReference.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TypesPackage.TYPED_ELEMENT__TYPE_REFERENCE, null, null);
        if (newTypeReference.eInternalContainer() == null)
        {
          msgs = newTypeReference.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TypesPackage.TYPED_ELEMENT__TYPE_REFERENCE, null, msgs);
        }
        if (msgs != null) msgs.dispatch();
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, TypesPackage.TYPED_ELEMENT__TYPE_REFERENCE, oldTypeReference, typeReference));
      }
    }
