 ...
 * <ul>
 *   <li>{@link org.emftext.language.java.expressions.impl.ConditionalAndExpressionImpl#getChildren <em>Children</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConditionalAndExpressionImpl extends ConditionalOrExpressionChildImpl implements ConditionalAndExpression
{
  ...
  public EList<ConditionalAndExpressionChild> getChildren()
  {
    if (children == null)
    {
      children = new EObjectContainmentEList.Resolving<ConditionalAndExpressionChild>(ConditionalAndExpressionChild.class, this, ExpressionsPackage.CONDITIONAL_AND_EXPRESSION__CHILDREN);
    }
    return children;
  }
