 ...
 * <ul>
 *   <li>{@link org.emftext.language.java.expressions.impl.InclusiveOrExpressionImpl#getChildren <em>Children</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InclusiveOrExpressionImpl extends ConditionalAndExpressionChildImpl implements InclusiveOrExpression
{
  ...
  public EList<InclusiveOrExpressionChild> getChildren()
  {
    if (children == null)
    {
      children = new EObjectContainmentEList.Resolving<InclusiveOrExpressionChild>(InclusiveOrExpressionChild.class, this, ExpressionsPackage.INCLUSIVE_OR_EXPRESSION__CHILDREN);
    }
    return children;
  }
