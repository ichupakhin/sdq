 ...
 * <ul>
 *   <li>{@link org.emftext.language.java.expressions.impl.ConditionalOrExpressionImpl#getChildren <em>Children</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConditionalOrExpressionImpl extends ConditionalExpressionChildImpl implements ConditionalOrExpression
{
  ...
  public EList<ConditionalOrExpressionChild> getChildren()
  {
    if (children == null)
    {
      children = new EObjectContainmentEList.Resolving<ConditionalOrExpressionChild>(ConditionalOrExpressionChild.class, this, ExpressionsPackage.CONDITIONAL_OR_EXPRESSION__CHILDREN);
    }
    return children;
  }
